    ...
    <div class="col-12">
        <div class="app-card app-card-settings shadow-sm p-4">
		    <div class="app-card-body">
			    <form class="settings-form" enctype="multipart/form-data" method="post" action="<?= base_url('inspections/update_process/'.encrypt_decrypt('encrypt', $inspections->id)) ?>">
			    	<div class="row">
			    	...
			    	<?php if ($inspections->status != 'Menunggu Pemeriksaan Dokter'): ?>
				    	<div class="row">

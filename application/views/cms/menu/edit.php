    ...
    <div class="col-12">
        <div class="app-card app-card-settings shadow-sm p-4">
		    ...
		    <div class="app-card-body">
			    <form class="settings-form" method="post" action="<?= base_url('menus/update/'.encrypt_decrypt('encrypt', $menu->id)) ?>">
				    <div class="mb-3">
			    	...
			    	<div class="mb-3">
					    ...
					    <input type="text" class="form-control" id="name" value="<?= set_value('name', $menu->name) ?>" name="name" required placeholder="">
						...
						<div class="mb-3 col-lg-8 col-12">
							...
							<div class="input-group mb-3">
							  <span class="input-group-text" id="group-icon">
							  	<span class="<?= set_value('icon', $menu->icon) ?>"></span>
							  </span>
							  <input type="text" class="form-control" name="icon" value="<?= set_value('icon', $menu->icon) ?>" id="icon" aria-describedby="group-icon">
							</div>
					...
					<div class="mb-3">
					    ...
					    <select name="access[]" id="access" class="form-control select2-tags" multiple data-placeholder="Buat Akses">
					    	<option ></option>
					    	<?php $access = json_decode($menu->access); foreach ($access as $value): ?>

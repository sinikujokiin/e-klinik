		...
		<div class="page-utilities">
			<div class="row g-2 justify-content-start justify-content-md-end align-items-center">
				<div class="col-auto">						    
					...
					<a class="btn app-btn-secondary" href="<?= base_url('doctors/create') ?>">
		...
		<div class="card-body">
			<div class="table-responsive">
				<table id="example" class="table table-striped" style="width:100%">
					...
					<tbody>
						<?php $no = 1; foreach ($doctors as $value): ?>
						<tr>
							<td class="cell"><?= $no++ ?>.</td>
							<td class="cell"><?= $value->code ?> 
								<?php if (cekAccess('accounts', 'create')): ?>
									<?= $value->account ? "" : "<a href='".base_url('doctors/create_account/'.encrypt_decrypt('encrypt',$value->id))."'>Buat Akun</a>"  ?></td>
								<?php endif ?>
							...
							<td class="cell">
								<div class="dropdown">
									...
									<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="z-index: 99999;">
										...
										<li>
											<a class="dropdown-item" href="<?= base_url('doctors/edit/'.encrypt_decrypt('encrypt', $value->id)) ?>"><i class="fa fa-pencil"></i> Ubah
											</a>
										</li>
										<?php endif ?>
										...
										<li>
											...
											<a class="dropdown-item" href="javascript:;" onclick="showModalDelete(this)" data-href="<?= base_url('doctors/destroy/'.encrypt_decrypt('encrypt', $value->id)) ?>"><i class="fa fa-trash"></i> Hapus
											</a>
										</li>
										<?php endif ?>
									</ul>

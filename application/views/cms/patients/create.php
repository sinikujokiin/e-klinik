    ...
    <div class="col-12">
        <div class="app-card app-card-settings shadow-sm p-4">
		    ...
		    <div class="app-card-body">
			    <form class="settings-form" enctype="multipart/form-data" method="post" action="<?= base_url('patients/store') ?>">
			    	<div class="row">
			    	...
			    	<div class="row">
			    		...
			    		<div class="col-lg-8 col-md-6 col-12">
					    	<div class="mb-3">
							    ...
							    <input type="date" max="<?= date('Y-m-d') ?>" class="form-control" id="dob" value="<?= set_value('dob') ?>" name="dob" required placeholder="">
			    	...
			    	<div class="row">
			    		<div class="col-lg-6 col-md-6 col-12">
					    	<div class="mb-3">
							    ...
							    <input type="number" min="0" class="form-control" id="phone" value="<?= set_value('phone') ?>" name="phone" required placeholder="">
			    		...
			    		<div class="col-lg-6 col-md-6 col-12">
					    	<div class="mb-3">
							    ...
							    <input type="email" min="0" class="form-control" id="email" value="<?= set_value('email') ?>" name="email" required placeholder="">
			    	...
			    	<div class="row">
			    		<div class="col-lg-6 col-12">
					    	<div class="mb-3">
					    		...
					    		<div class="form-check">
								  <input class="form-check-input type" type="radio" name="type" checked value="UMUM" id="umum">
								  <label class="form-check-label" for="umum">
								    UMUM
								  </label>
								</div>
								<div class="form-check">
								  <input class="form-check-input type" type="radio" name="type" value="BPJS" id="bpjs">
			    		...
			    		<div class="col-lg-6 col-md-6 col-12" id="form-bpjs" hidden>
					    	<div class="mb-3">
							    <label for="bpjs_number" class="form-label">Nomer BPJS</label>
							    <input type="number" class="form-control" id="bpjs_number" value="<?= set_value('bpjs_number') ?>" name="bpjs_number" placeholder="">
			    	...
			    	<div class="row">
			    		<div class="col-lg-6 col-6">
					    	<div class="mb-3">
							    ...
							    <div class="form-check">
								  <input class="form-check-input" type="radio" name="gender" checked value="Laki-Laki" id="lk">
								  <label class="form-check-label" for="lk">
								    Laki-Laki
								  </label>
								</div>
								<div class="form-check">
								  <input class="form-check-input" type="radio" name="gender" value="Perempuan" id="pr">
...
<script>
	...
	$(".type").change(function(){
		if ($(this).val() == 'BPJS') {
			$("#form-bpjs").attr('hidden',false).attr('required', true);
		}else{
			$("#form-bpjs").attr('hidden',true).attr('required', false);

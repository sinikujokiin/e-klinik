    ...
    <div class="col-12">
        <div class="app-card app-card-settings shadow-sm p-4">
		    ...
		    <div class="app-card-body">
			    <form class="settings-form" enctype="multipart/form-data" method="post" action="<?= base_url('medicines/store') ?>">
			    	<div class="row">
					...
					<div class="row">
						<div class="col-lg-5 col-md-6 col-12">
					    	<div class="mb-3">
							    ...
							    <input type="number" min="0" class="form-control" id="stock_min" value="<?= set_value('stock_min') ?>" name="stock_min" required placeholder="">
			    		...
			    		<div class="col-lg-5 col-md-6 col-12">
					    	<div class="mb-3">
							    ...
							    <input type="number" min="0" class="form-control" id="stock" value="<?= set_value('stock') ?>" name="stock" required placeholder="">
					    	...
					    	<div class="mb-3">
							    ...
							    <select class="form-control select2-tag" id="unit" name="unit" data-placeholder="Pilih Unit">
							    	...
							    	<?php foreach ($units as $key => $value): ?>
								    	<option <?= $value->unit == set_value('unit') ?>><?= $value->unit ?></option>
							    	<?php endforeach ?>
							    </select>
			    	...
			    	<div class="row">
			    		<div class="col-lg-5 col-md-4 col-12">
					    	<div class="mb-3">
							    ...
							    <input type="number" min="0" class="form-control" id="purchase_price" value="<?= set_value('purchase_price') ?>" name="purchase_price" required placeholder="">
			    		...
			    		<div class="col-lg-5 col-md-4 col-12">
					    	<div class="mb-3">
							    ...
							    <input type="number" min="0" class="form-control" id="selling_price" value="<?= set_value('selling_price') ?>" name="selling_price" required placeholder="">
					    	...
					    	<div class="mb-3">
							    ...
							    <select class="form-control select2-tag" name="type" id="type" data-placeholder="Pilih Kategori Obat">
							    	...
							    	<?php foreach ($type as $key => $value): ?>
								    	<option <?= set_value('type') == $value->type ? 'selected' : '' ?>><?= $value->type ?></option>
							    	<?php endforeach ?>
							    </select>
